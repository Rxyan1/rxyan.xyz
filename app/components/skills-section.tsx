...
export function SkillsSection() {
  ...
  // Utilitaire pour afficher les skills sous forme de box
    ...
    <div className="flex flex-wrap gap-3 mt-2 justify-center">
      {skills.map((skill, idx) => (
        <motion.span
          ...
          className="px-4 py-1 rounded bg-gray-800/80 text-sky-200 border border-gray-700 text-sm font-semibold shadow hover:bg-sky-900/60 hover:text-sky-100 transition-colors duration-200"
        >
          {skill}
        </motion.span>
      ))}

...
!((t, i, e, s) => {
  ...
  ;(n.prototype.transformSupport = function (t) {
    for (
      var n = e.createElement("div"), o = !1, r = null, a = !1, h = null, l = null, p = 0, c = this.vendors.length;
      c > p;
      p++
    )
      if (
    ...
    (n.prototype.clamp = (t, i, e) => ((t = Math.max(t, i)), (t = Math.min(t, e)))),
    ...
    (n.prototype.onAnimationFrame = function () {
      ...
      ;(Math.abs(t) > this.calibrationThreshold || Math.abs(i) > this.calibrationThreshold) && this.queueCalibration(0),
        ...
        isNaN(Number.parseFloat(this.limitX)) || (this.mx = this.clamp(this.mx, -this.limitX, this.limitX)),
        isNaN(Number.parseFloat(this.limitY)) || (this.my = this.clamp(this.my, -this.limitY, this.limitY)),
  ...
  (() => {
    ...
    window.requestAnimationFrame ||
      (window.requestAnimationFrame = (i, e) => {
